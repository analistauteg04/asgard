...
GRANT ALL PRIVILEGES ON `db_captacion`.* TO 'utegasgard'@'localhost' IDENTIFIED BY 'Ut3G4dmi1n-d364rr00@ll20167*Onl1n3W@';
-- --------------------------------------------------------
--
...
create table if not exists `solicitud_captacion` (
 ...
 `rcap_fecha_ingreso` timestamp not null default current_timestamp,
