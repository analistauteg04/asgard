...
--
INSERT INTO `nivel_interes` (`nint_id`, `nint_nombre`, `nint_descripcion`, `nint_estado`, `nint_estado_logico`) VALUES
(1, 'Grado', 'Grado', '1', '1'),
(2, 'Grado Online', 'Grado Online', '1', '1'),
(3, 'Posgrado', 'Posgrado', '1', '1');
...
(1, 'Curso de nivelación y admisión', 'Curso de admisión y nivelación', '1', '1'),
(2, 'Examen de admisión', 'Examen de admisión', '1', '1'),
(3, 'Homologación', 'Homologación', '0', '1'),
(4, 'Propedéutico', 'Propedéutico', '0', '1');

-- --------------------------------------------------------
--
-- Volcado de datos para la tabla `nivelint_metodo`
--
INSERT INTO `nivelint_metodo` (`nmet_id`, `nint_id`, `ming_id`, `nmet_estado`, `nmet_estado_logico`) VALUES
(1, 1, 1, '1', '1'),
(2, 1, 2, '1', '1'),
(3, 1, 3, '1', '1'),
(4, 2, 1, '1', '1'),
...
--
INSERT INTO `doc_nint_tciudadano` (`dntc_id`, `tciu_id`, `nint_id`, `dadj_id`, `dntc_estado`, `dntc_estado_logico`) VALUES
(1, 1, 1, 1, '1', '1'),
(2, 1, 1, 2, '1', '1'),
(3, 1, 1, 3, '1', '1'),
(4, 1, 1, 4, '1', '1'), 
...
-- --------------------------------------------------------
--
-- Volcado de datos para la tabla `info_familia` 
--
...
-- --------------------------------------------------------
--
-- Volcado de datos para la tabla `info_familia_enfermedad` 
--
...
-- --------------------------------------------------------
--
-- Volcado de datos para la tabla `info_familia_discapacidad` 
--
