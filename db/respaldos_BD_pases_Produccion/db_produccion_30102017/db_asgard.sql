...
GRANT ALL PRIVILEGES ON `db_asgard`.* TO 'utegasgard'@'localhost' IDENTIFIED BY 'Ut3G4dmi1n-d364rr00@ll20167*Onl1n3W@';
...
create table if not exists `tipo_persona` (
 ...
 `tipe_nombre` varchar(250) default null,
 `tipe_estado` varchar(1) not null,
 `tipe_fecha_creacion` timestamp not null default current_timestamp on update current_timestamp,
 `tipe_fecha_modificacion` timestamp null default null,
 `tipe_estado_logico` varchar(1) not null
) ;
...
create table if not exists `ambiente` (
  `amb_id` bigint(20) not null auto_increment primary key,
  `amb_descripcion` varchar(200) not null,    
  `amb_estado` varchar(1) not null,
  `amb_fecha_creacion` timestamp not null default current_timestamp,
  `amb_fecha_modificacion` timestamp null default null,
  `amb_estado_logico` varchar(1) not null
);
...
-- --------------------------------------------------------
--
-- Estructura de tabla para la tabla `persona_preins`
--
create table if not exists `persona_preins` (
 `ppre_id` bigint(20) not null auto_increment primary key,
 `ppre_pri_nombre` varchar(250) default null,
 `ppre_seg_nombre` varchar(250) default null,
 `ppre_pri_apellido` varchar(250) default null, 
 `ppre_seg_apellido` varchar(250) default null,
 `ppre_cedula` varchar(15) not null,
 `ppre_ruc` varchar(15) default null,
 `ppre_pasaporte` varchar(50) default null,
 `etn_id` bigint(20) default null,
 `eciv_id` bigint(20) default null,
 `ppre_genero` varchar(1) default null,
 `ppre_nacionalidad` varchar(250) default null,
 `pai_id_nacimiento` bigint(20) default null,
 `pro_id_nacimiento` bigint(20) default null,
 `can_id_nacimiento` bigint(20) default null,
 `ppre_nac_ecuatoriano` varchar(1) default null,
 `ppre_fecha_nacimiento` date default null,
 `ppre_celular` varchar(50) default null,
 `ppre_correo` varchar(250) default null,
 `ppre_foto` varchar(500) default null,
 `tsan_id` bigint(20) default null,

 `ppre_domicilio_sector` varchar(250) default null,
 `ppre_domicilio_cpri` varchar(500) default null,
 `ppre_domicilio_csec` varchar(500) default null,
 `ppre_domicilio_num` varchar(100) default null,
 `ppre_domicilio_ref` varchar(500) default null,
 `ppre_domicilio_telefono` varchar(50) default null,
 `pai_id_domicilio` bigint(20) default null, 
 `pro_id_domicilio` bigint(20) default null, 
 `can_id_domicilio` bigint(20) default null,
  
 `ppre_trabajo_nombre` varchar(250) default null,
 `ppre_trabajo_direccion` varchar(500) default null,
 `ppre_trabajo_telefono` varchar(50) default null, 
 `ppre_trabajo_ext` varchar(50) default null,
 `pai_id_trabajo` bigint(20) default null, 
 `pro_id_trabajo` bigint(20) default null,
 `can_id_trabajo` bigint(20) default null,

 `ppre_fecha_registro` timestamp null,
 ...
 foreign key (etn_id) references `etnia`(etn_id), 
 foreign key (tsan_id) references `tipo_sangre`(tsan_id),
 unique ppre_cedula(ppre_cedula) 
);