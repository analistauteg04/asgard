...
create table if not exists `temporal_wizard_inscripcion` (
 ...
 `ruta_doc_titulo` varchar(200) not null,
 `ruta_doc_dni` varchar(200) not null, 
 `ruta_doc_certvota` varchar(200) not null, 
 `ruta_doc_foto` varchar(200) not null, 
 `ruta_doc_certificado` varchar(200) not null, 
 `twin_mensaje1` varchar(1) not  null,
 `twin_mensaje2` varchar(1) not  null,
