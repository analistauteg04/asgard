...
-- --------------------------------------------------------
--
-- Estructura de tabla para la tabla `asignatura_planificacion_acad`
--
create table if not exists `asignatura_planificacion_acad` (
  ...
  `apac_fecha_creacion` timestamp null default current_timestamp,
...
-- Estructura de tabla para la tabla `asignatura`
--
create table if not exists `docente_asigntura` ( 
  `dasi_id` bigint(20) not null auto_increment primary key,
  `per_id` bigint(20) not null,  
  `casi_id` bigint(20) not null,
  `uaca_id` bigint(20) not null,
  `dasi_hora_ini` timestamp null default null,
  `dasi_hora_fin` timestamp null default null,
  `dasi_cant_horas` varchar(50) not null,
...
-- Estructura de tabla para la tabla `asignatura`
--
create table if not exists `marcacion_docente` ( 
  `mdoc_id` bigint(20) not null auto_increment primary key,
  `per_id` bigint(20)  null,  
  `dasi_id` bigint(20)  null,
  `mdoc_hora_ini` varchar(100) null default null,
  `mdoc_hora_fin` varchar(100) null default null,
  `mdoc_estado` varchar(1)  null,
  `mdoc_fecha_creacion` timestamp  null default current_timestamp,
  `mdoc_fecha_modificacion` timestamp null default null,
  `mdoc_estado_logico` varchar(1)  null  
);