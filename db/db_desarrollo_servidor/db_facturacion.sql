...
create table if not exists `historial_item_precio` (
  `hipr_id` bigint(20) not null primary key,
  `ite_id` bigint(20) not null,
...
create table if not exists `descuento_item` (
  ...
  `ite_id` bigint(20) not null,
  `dite_porcentaje` double not null,
  `dite_descripcion` varchar(100) null,
  `dite_fecha_inicio`  timestamp null,
  `dite_fecha_fin`  timestamp null, 
  `dite_estado_descuento`  varchar(1) not null,
...
create table if not exists `historial_descuento_item` (
  ...
  `ite_id` bigint(20) not null,
  `hdit_porcentaje` double not null,
