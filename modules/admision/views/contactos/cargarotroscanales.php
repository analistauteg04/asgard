...
?>
<div class="col-md-12">    
    <h3><span id="lbl_titulo"><?= Yii::t("formulario", "Carga Otros Canales") ?></span><br/>    
</div>
<div class="col-md-12">    
    <br/>    
</div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
        ...
        <div class='col-md-12 col-sm-12 col-xs-12 col-lg-12'>        
            ...
            <div class="col-sm-2 col-md-2 col-xs-4 col-lg-2">                
                <a id="btn_cargarotroscanales" href="javascript:" class="btn btn-primary btn-block"> <?= Yii::t("formulario", "Send") ?></a>
            </div>        
        </div>
    </div>
