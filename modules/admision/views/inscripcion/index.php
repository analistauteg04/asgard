        ...
        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
            <div class="form-group">
                ...
                <div class="col-sm-8 col-md-8 col-xs-8 col-lg-8">
                    <input type="text" class="form-control" value="" id="txt_buscarData" placeholder="<?= admision::t("Solicitudes", "Search by item") ?>: <?= Yii::t("formulario", "City") ?>, <?= Yii::t("formulario", "State") ?>, <?= financiero::t("Pagos", "Agente") ?>, <?= Yii::t("formulario", "Names") ?> ">
                </div>
            </div>
        </div>
        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
