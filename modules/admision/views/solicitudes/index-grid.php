            ...
            [
                ...
                'buttons' => [                
                    'view' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-check"></span>', Url::to(['/admision/solicitudes/view', 'ids' => base64_encode($model['sins_id']), 'int' => base64_encode($model['int_id']), 'perid' => base64_encode($model['persona']), 'apellidos' => base64_encode($model['per_apellidos']), 'nombres' => base64_encode($model['per_nombres']), 'uaca_nombre' => base64_encode($model['uaca_nombre']), 'carrera' => base64_encode($model['carrera']), 'fec_repro' => base64_encode($model['sins_fecha_reprobacion']), 'observacion' => base64_encode($model['sins_observacion']), 'uaca_id' => base64_encode($model['uaca_id']), 'num_solicitud' => base64_encode($model['num_solicitud'])]), ["data-toggle" => "tooltip", "title" => "Ver Solicitud", "data-pjax" => 0]);                        
                    },                                             
                ],
            ],
