...
<?= Html::hiddenInput('txth_opo_id', base64_encode($actividad_oportunidad["opo_id"]), ['id' => 'txth_opo_id']); ?>
...
<form class="form-horizontal" enctype="multipart/form-data" >
    ...
    $fecha = $fecha_hora[0];
    $hora_3 = $fecha_hora[1];
    $hora_arr = explode(":", $hora_3);
    $hora = $hora_arr[0] . ":" . $hora_arr[1];
    $fecha_proxima_atencion = $actividad_oportunidad['bact_fecha_proxima_atencion'];
    $fecha_hora_proxima = explode(" ", $fecha_proxima_atencion);
    $fecha_proxima = $fecha_hora_proxima[0];
    $hora_3_p = $fecha_hora_proxima[1];
    $hora_arr_p = explode(":", $hora_3_p);
    if (strlen($hora_3_p) > 0)
        $hora_proxima = $hora_arr_p[0] . ":" . $hora_arr_p[1];
    else
        $hora_proxima = '';
    ?>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">          
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                ...
                <div class="col-sm-3 col-md-3 col-xs-3 col-lg-3">                    
                    <input type="text" class="form-control PBvalidation" value="<?php echo $hora; ?>" id="txt_hora_atencion" data-type="tiempo" data-keydown="true" placeholder="<?= Yii::t('formulario', 'HH:MM') ?>">
                </div> 
            </div>                    
        </div>     
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                ...
                <div class="col-sm-4 col-md-4 col-xs-4 col-lg-4 ">
                    ...
                    DatePicker::widget([
                        ...
                        'disabled' => $disable,
                        'type' => DatePicker::TYPE_INPUT,
                        'options' => ["class" => "form-control" . $validation . " keyupmce", "id" => "txt_fecha_proxima", "data-type" => "fecha_pro", "data-keydown" => "true", "placeholder" => Yii::t("formulario", "Date")],
                        'pluginOptions' => [
                            'autoclose' => true,
                            'format' => Yii::$app->params["dateByDatePicker"],
                        ]
    ...
    <div class='col-md-12 col-sm-12 col-xs-12 col-lg-12'>
        ...
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">            
            <div class="form-group">
                ...
                <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                    <textarea  class="form-control keyupmce" rows="5" id="txt_descripcion"><?= $actividad_oportunidad["bact_descripcion"] ?></textarea>                  
                </div>
            </div>
        </div>
    </div>  
