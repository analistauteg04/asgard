...
<form class="form-horizontal" enctype="multipart/form-data" > 
    <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 ">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">       
            ...
            <!-- <table width="1000px">
                <tr><td style="text-align: right;"><canvas id="canvas_tt5c5e053aeca1f" width="175" height="175"></canvas></td></tr>
                <tr><td style="text-align: right; font-weight: bold">
                    <a href="//24timezones.com/es_husohorario/guayaquil_hora_actual.php" style="text-decoration: none" class="clock24" id="tz24-1549665594-c193-eyJzaXplIjoiMTc1IiwiYmdjb2xvciI6IjAwOTlGRiIsImxhbmciOiJlcyIsInR5cGUiOiJhIiwiY2FudmFzX2lkIjoiY2FudmFzX3R0NWM1ZTA1M2FlY2ExZiJ9" rel="nofollow"></a></td></tr>
            </table>
            <script type="text/javascript" src="//w.24timezones.com/l.js" async></script>  -->  
        </div>
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 ">    
            <!--<div class="col-md-7 col-sm-7 col-xs-7 col-lg-7">
                <div class="form-group">
                    <h4><span id="lbl_general"><?= $semana[$dia] . ' ' . date("d-m-Y") ?></span></h4> 
                </div>
            </div>-->
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 "> 
