...
<div class="col-md-12">    
    <h3><span id="lbl_Personeria"><?= financiero::t("Pagos", "Upload Contract") ?></span>
</div>
<?= Html::hiddenInput('txth_adm_id', base64_decode($_GET['admi']), ['id' => 'txth_adm_id']); ?>

<form class="form-horizontal">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            <label for="cmb_convenio" class="col-sm-2 col-md-2 col-xs-2 col-lg-2 control-label"><?= Yii::t("formulario", "Company Agreement") ?></label>
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">       
                <?= Html::dropDownList("cmb_convenio", 0, $arr_convenio_empresa, ["class" => "form-control", "id" => "cmb_convenio"]) ?>
            </div>
        </div>
    </div>   
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7 ">
                ...
                echo CFileInputAjax::widget([
                    ...
                    'pluginOptions' => [
                        ...
                        'uploadUrl' => Url::to(['pagos/savecontrato']),
