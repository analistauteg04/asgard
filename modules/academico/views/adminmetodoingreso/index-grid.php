            ...
            [
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-check"></span>', Url::to(['adminmetodoingreso/newparalelo', 'pami_id' => $model['pami_id'], 'codigo' => $model['codigo']]), ["data-toggle" => "tooltip", "title" => "Registrar Paralelos", "data-pjax" => 0]);
                    },
