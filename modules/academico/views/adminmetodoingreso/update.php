...
<div class="col-md-12">    
    <h3><span id="lbl_titulo"><?= Yii::t("academico", "Update CAN Period") ?></span><br/>    
</div>
    ...
    <div class='col-md-12 col-sm-12 col-xs-12 col-lg-12'>
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control PBvalidation" value="<?= $mod_periodo["pmin_anio"] ?>" id="txt_anio" data-type="graduacion" data-keydown="true" placeholder="<?= Yii::t("academico", "Year") ?>">
                </div>
            </div>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
