...
<form class="form-horizontal">    
    <div class="form-group">
        <label for="frm_usu_user" class="col-sm-3 control-label"><?= Yii::t("login", "Username") ?></label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="frm_clave" class="col-sm-3 control-label"><?= Yii::t("login", "Password") ?></label>
        <div class="col-sm-9">
            <div class="input-group">
                <?= Html::passwordInput("frm_clave", $usuario_model->usu_password, ["class" => "form-control PBvalidation", "data-type" => "all", "id" => "frm_clave", "disabled" => "disabled","placeholder" => Yii::t("login", "Password") ]) ?>
    ...
    <div class="form-group">
        <label for="cmb_empresa" class="col-sm-3 control-label"><?= Yii::t("formulario", "Company") ?></label>
        <div class="col-sm-9">
