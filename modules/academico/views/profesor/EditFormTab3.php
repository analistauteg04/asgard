...
<form class="form-horizontal">    
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            <label for="frm_clave" class="col-lg-3 col-md-3 col-xs-3 col-sm-3 control-label"><?= Academico::t("profesor", "Password") ?></label>
            <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            <label for="cmb_grupo" class="col-lg-3 col-md-3 col-xs-3 col-sm-3 control-label"><?= Academico::t("profesor", "Name of Group") ?></label>
            <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            <label for="cmb_rol" class="col-lg-3 col-md-3 col-xs-3 col-sm-3 control-label"><?= Academico::t("profesor", "Name of Role") ?></label>
            <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            <label for="cmb_empresa" class="col-lg-3 col-md-3 col-xs-3 col-sm-3 control-label"><?= Academico::t("profesor", "Company") ?></label>
            <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
