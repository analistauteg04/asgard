...
<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-8 col-md-8 col-xs-8 col-lg-8">
                <input type="text" class="form-control" value="" id="txt_buscarDataPago" placeholder="<?= Yii::t("formulario", "Search by Person Names") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
    ...
    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">   
        <div class="form-group">
             <label for="lbl_fpago" class="col-sm-2 col-md-2 col-xs-2 col-lg-2 control-label" id="lbl_fpago"><?= Yii::t("formulario", "Forma Pago") ?></label>
                    <div class="col-sm-3 col-md-3 col-xs-3 col-lg-3">
                        <?=
                        Html::dropDownList(
