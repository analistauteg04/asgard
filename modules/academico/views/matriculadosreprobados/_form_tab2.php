...
<form class="form-horizontal">  
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">   
        ...
        <div class="col-md-2">
            <a id="sendInformacionAdmitidoPendDos" href="javascript:" class="btn btn-primary btn-block"> <?= Yii::t("formulario", "Next") ?> <span class="glyphicon glyphicon-menu-right"></span></a>
        </div>
    </div>        
</form>