...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-8 col-md-8 col-xs-8 col-lg-8 ">
                <input type="text" class="form-control" value="" id="txt_buscarData" placeholder="<?= Yii::t("formulario", "Search by Code or course") ?>">
            </div>
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">            
            ...
            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
                <?= Html::dropDownList("cmb_unidadbus", 2,  $arr_unidad , ["class" => "form-control", "id" => "cmb_unidadbus", "disabled" => "true"]) ?>
            </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">      
            <label for="cmb_programabus" class="col-sm-2 col-sm-2 col-lg-2 col-md-2 col-xs-2 control-label"><?= Yii::t("formulario", "Program") ?></label>
            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
                <?= Html::dropDownList("cmb_programabus", 0, $arr_programa1, ["class" => "form-control", "id" => "cmb_programabus"]) ?>
            </div>       
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
