...
<form class="form-horizontal" enctype="multipart/form-data" id="formsolicitud">    
    ...
    <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12" >
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="form-group">
                <label for="cmb_categoria" id="lbl_carrera" class="col-sm-5 col-md-5 col-xs-5 col-lg-5 control-label keyupmce"><?= Yii::t("formulario", "Category") ?></label>
                <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
    ...
    <div class='col-md-12 col-sm-12 col-xs-12 col-lg-12'>
            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                <div class="form-group">
                    <label for="txt_matricula" class="col-sm-5 col-md-5 col-xs-5 col-lg-5 control-label" id="lbl_nombre1"><?= academico::t("Academico", 'Enrollment Number') ?></label>
                    <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                        <input type="text" class="form-control PBvalidation keyupmce" value="" id="txt_matricula" data-type="number" placeholder="<?= academico::t("Academico", 'Enrollment Number') ?>">
                    </div>
                </div>
            </div>             
        </div>
