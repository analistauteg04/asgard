...
class CActiveRecord extends \yii\db\ActiveRecord {
    ...
    {
        $connection = new \app\components\CConnection(Yii::$app->controller->module->db_fe_edoc);
        return $connection;
    ...
    {
        if(Yii::$app->controller->module->db_fe_edoc["dbname"]){
            $dbname = StringHelper::basename(Yii::$app->controller->module->db_fe_edoc["dbname"]);
