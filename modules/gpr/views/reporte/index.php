...
<div class="row">
    <form class="form-horizontal">
        ...
        <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
            <div class="form-group">
                <label for="cmb_treporte" class="col-sm-2 col-sm-2 col-lg-2 col-md-2 col-xs-2 control-label"><?= gpr::t("reporte", 'Report Type') ?></label>
                <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
                    <?= Html::dropDownList("cmb_treporte", "0", $arr_reporte, ["class" => "form-control", "id" => "cmb_treporte"]) ?>                                
                </div>          
            </div>
        </div>
        <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
            ...
            <div class="col-sm-2 col-md-2 col-xs-4 col-lg-2">                
                <a id="btn_buscarData" href="javascript:" class="btn btn-primary btn-block"> <?= gpr::t("reporte", "Download") ?></a>
            </div>
        </div>
    </form>
</div>
