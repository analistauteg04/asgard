    ...
    PbGridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'header' => gpr::t("objetivoespecifico", 'Specific Objective Description'),
                'value' => 'Descripcion',
            ],
            [
            ...
            [
                ...
                'format' => 'html',
                'header' => gpr::t("objetivoespecifico", "Specific Objective Status"),
                'value' => function($data){
                    if($data["Estado"] == "1")
                        return '<small class="label label-success">'.gpr::t("objetivoespecifico", "Specific Objective Enabled").'</small>';
                    else
                        return '<small class="label label-danger">'.gpr::t("objetivoespecifico", "Specific Objective Disabled").'</small>';
                },
            ],
            [
                'class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        return Html::a('<span class="'.Utilities::getIcon('view').'"></span>', Url::to(['/gpr/objetivoespecifico/view', 'id' => $model['id']]), ["data-toggle" => "tooltip", "title" => Yii::t("accion","View")]);
