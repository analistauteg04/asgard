            ...
            [
                ...
                'buttons' => [
                    ...
                    'rmsubs' => function ($url, $model) {
                        if ($model["estado_mailchimp"] == 0){
                            if ($model["estado"] == 1) {
                                return Html::a('<span class="glyphicon glyphicon-remove"></span>', "#", ["onclick" => "RemoverSuscritor(" . $model['per_id'] . "," . $model['id_psus'] . "," . $model['per_tipo'] . "," . $model['lis_id'] . ");", "data-toggle" => "tooltip", "title" => "Eliminar Suscritor", "data-pjax" => 0]);
                            } else {
