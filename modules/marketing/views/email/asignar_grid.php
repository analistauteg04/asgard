            ...
            [
                ...
                'buttons' => [
                    'addsubs' => function ($url, $model) {
                        if ($model["estado_mailchimp"] == 0){
                            if (($model["estado"] == 1)) {
                                ...
                                return Html::a('<span class="glyphicon glyphicon-plus"></span>', "#", ["onclick" => "preguntasuscribirContacto(" . $model['per_id'] . "," . $model['pges_id'] . "," . $model['lis_id'] .");", "data-toggle" => "tooltip", "title" => "Suscribirse a la lista", "data-pjax" => 0]);
                            }
                        }else{
                            return '<span class="glyphicon glyphicon-plus"></span>';
                        }
                    ...
                    'rmsubs' => function ($url, $model) {
                        if ($model["estado_mailchimp"] == 0){
                            if ($model["estado"] == 1) {
                                return Html::a('<span class="glyphicon glyphicon-remove"></span>', "#", ["onclick" => "RemoverSuscritor(" . $model['per_id'] . "," . $model['pges_id'] . "," . $model['lis_id'] . ");", "data-toggle" => "tooltip", "title" => "Eliminar Suscritor", "data-pjax" => 0]);
                            } else {
