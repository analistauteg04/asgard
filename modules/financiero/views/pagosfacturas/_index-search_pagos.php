...
<div class="row">    
    ...
    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">   
        <div class="form-group">
            <label for="lbl_unidad_pagos" class="col-sm-2 col-md-2 col-xs-2 col-lg-2 control-label" id="lbl_unidad"><?= academico::t("Academico", "Academic unit") ?></label>
            <div class="col-sm-3 col-md-3 col-xs-3 col-lg-3">                                      
            ...
            <label for="lbl_modalidad_pagos" class="col-sm-2 col-md-2 col-xs-2 col-lg-2 control-label"><?= academico::t("Academico", "Modality") ?></label>
            <div class="col-sm-3 col-md-3 col-xs-3 col-lg-3">                                
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        ...
        <div class="col-sm-2 col-md-2 col-xs-4 col-lg-2">                
            <a id="btn_buscarpagoest" href="javascript:" class="btn btn-primary btn-block"> <?= Yii::t("formulario", "Search") ?></a>
        </div>
    </div>
</div></br>
