 ...
 */
array_unshift($arr_modalidad, "Todos");
?>
<div class="row">
    ...
    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
        <div class="form-group">
            <label for="cmb_unidad" class="col-sm-2 col-md-2 col-xs-2 col-lg-2 control-label"><?= Yii::t("formulario", "Academic unit") ?></label>
            <div class="col-sm-3 col-md-3 col-xs-3 col-lg-3">
                <?= Html::dropDownList("cmb_unidad", 0, $arr_ninteres, ["class" => "form-control", "id" => "cmb_unidad", "disabled" => "true"]) ?>
            </div>                   
            <label for="cmb_modalidades" class="col-sm-2 col-md-2 col-xs-2 col-lg-2 control-label"><?= Yii::t("formulario", "Mode") ?></label>
            <div class="col-sm-3 col-md-3 col-xs-3 col-lg-3">
    ...
    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
        <div class="form-group">
            <label for="cmb_carreras" class="col-sm-2 col-md-2 col-xs-2 col-lg-2 control-label"><?= Yii::t("academico", "Career") ?></label>
            <div class="col-sm-3 col-md-3 col-xs-3 col-lg-3">
                <?= Html::dropDownList("cmb_carreras", 0, $arrCarreras, ["class" => "form-control", "id" => "cmb_carreras"]) ?>
            </div>
