...
<div class="col-md-12">    
    <h3><span id="lbl_titulo"><?= Yii::t("academico", "Update CAN Period online") ?></span><br/>    
</div>
    ...
    <div class='col-md-12 col-sm-12 col-xs-12 col-lg-12'>
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <?= Html::dropDownList("cmb_nivel_interes", 2, $arr_ninteres, ["class" => "form-control", "id" => "cmb_nivel_interes", 'disabled' => "true"]) ?>
                </div>
            </div>
        </div> 
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
