...
$(document).ready(function () {
    ...
    $('#cmb_pais_dom').change(function () {
        var link = $('#txth_base').val() + "/inscripcionuteg/index";
    ...
    $('#sendInscripcion').click(function () {
        var link = $('#txth_base').val() + "/inscripcionuteg/guardarinscripcion";
        var arrParams = new Object();
        ...
        if (!validateForm()) {
            requestHttpAjax(link, arrParams, function (response) {
                ...
                if (!response.error) {
                    setTimeout(function () {
                        window.location.href = $('#txth_base').val() + "/inscripcionuteg/index";
                    }, 5000);
                }
