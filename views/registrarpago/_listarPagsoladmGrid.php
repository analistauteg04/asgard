            ...
            [
                ...
                'buttons' => [
                    ...
                    'upload' => function ($url, $model) {
                        if ($model['rol'] == 1) {
                            return Html::a('<span class="glyphicon glyphicon-download-alt"></span>', Url::to(['registrarpago/cargardocpagos', 'ids' => base64_encode($model['orden']), /*'tot' => base64_encode($model['ipre_precio_siva']),*/ 'estado' => base64_encode($model['estado_desc_pago']), 'vista' => 'adm']), ["data-toggle" => "tooltip", "title" => "Subir Documento", "data-pjax" => 0]);
                        }
                    },
                ],
            ],
