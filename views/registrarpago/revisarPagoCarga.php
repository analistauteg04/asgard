...
<form class="form-horizontal" enctype="multipart/form-data" >
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-8 col-md-8 col-xs-8 col-lg-8 ">    
                <?php if ($estado == 'PE') { ?> 
                             <!--<input type="text" class="form-control PBvalidation keyupmce" id="txt_observacion" data-type="alfa" data-keydown="true" placeholder="<?= Yii::t("formulario", "Observations") ?>">  -->
                ...
                <?php } else { ?>
                        <!--<input type="text" value= "<?= $observacion ?>" readonly="readonly" class="form-control" id="txt_observacion" data-type="alfa" data-keydown="true" placeholder="<?= Yii::t("formulario", "Observations") ?>">-->  
