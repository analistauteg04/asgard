...
$(document).ready(function () {
    ...
    $('#btn_enviar').click(function () {
        ...
        var link = $('#txth_base').val() + "/registrarpago/crearpago";
        ...
        if ($('#cmb_revision').val() == "AP") {
            //$('#txt_observacion').removeClass("PBvalidation");
        ...
        if (!validateForm()) {
            requestHttpAjax(link, arrParams, function (response) {
                ...
                setTimeout(function () {
                    parent.window.location.href = $('#txth_base').val() + "/registrarpago/validarpagocarga?ido=" + arrParams.opag_id;
                }, 2000);
    ...
    $('#cmd_enviarData').click(function () {
        var arrParams = new Object();
        var link = $('#txth_base').val() + "/registrarpago/crearcargapago";
...
function exportExcel(){
    ...
    window.location.href = $('#txth_base').val() + "/registrarpago/expexcel?search="+search+"&f_ini="+f_ini+"&f_fin="+f_fin;
}
