...
$requisitosCANP = ' <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-xs-9 col-lg-9">
                            <div style = "width: 1200px;" class="alert alert-info"><span style="font-weight: bold">Fecha curso de nivelación del 22 de octubre al 30 de noviembre del 2018 deberás cargar en el siguiente paso estos documentos: <br></span>
...
$requisitosCANAD = ' <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-xs-9 col-lg-9">
                            <div style = "width: 1200px;" class="alert alert-info"><span style="font-weight: bold">Fecha curso de nivelación del 20 de octubre al 8 de diciembre del 2018 deberás cargar en el siguiente paso estos documentos: <br></span>
                                Cédula de identidad o pasaporte. <br>
                                Certificado de votación. <br>
                                Título de bachiller notarizado. <br>
                                Foto Actual. <br>
...
$requisitosCANO = ' <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-xs-9 col-lg-9">
                            <div style = "width: 1200px;" class="alert alert-info"><span style="font-weight: bold">Fecha curso de nivelación del 22 de octubre al 14 de diciembre del 2018 deberás cargar en el siguiente paso estos documentos: <br> </span>
                                Cédula de identidad o pasaporte. <br>
                                Certificado de votación. <br>
                                Título de bachiller notarizado. <br>
                                Foto Actual. <br>
...
$requisitosEXP = ' <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-xs-9 col-lg-9">
                            <div style = "width: 1200px;" class="alert alert-info"><span style="font-weight: bold">Al inscribirte al examen de admisión, tendrás acceso al Campus Virtual UTEG para prepararte. A partir de la fecha de registro tendrás un mes para rendir el examen de manera online: <br></span>
                                Cédula de identidad o pasaporte. <br>
                                Certificado de votación. <br>
                                Título de bachiller notarizado. <br>
                                Foto Actual. <br>
...
$requisitosPRP = '<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-xs-9 col-lg-9">
                            <div style = "width: 1200px;" class="alert alert-info"><span style="font-weight: bold">Fecha del taller introductorio: 13 y 14 de octubre del 2018. <br> 
                                    Deberás cargar en el siguiente paso estos documentos:<br></span>
                                    Cédula de identidad o pasaporte <br>
                                    Certificado de votación <br>
...
$requisitosHOMO = ' <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9 col-xs-9 col-lg-9">
                            <div style = "width: 1200px;" class="alert alert-info"><span style="font-weight: bold">Deberás cargar en el siguiente paso estos documentos:<br></span>
                                Cédula de identidad o pasaporte. <br>
                                Certificado de votación. <br>
                                Título de bachiller notarizado. <br>
                                Foto Actual. <br>
