...
<div class="col-md-12">
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs tabsdatos col-md-12">
            ...
            <li><a href="#paso7" data-toggle="tab" aria-expanded="false"><img class="" src="<?= Url::home() ?>img/users/n7.png" alt="User Image">  <?= Yii::t("formulario", "Validation") ?></a></li>            
        </ul>
        <div class="tab-content col-md-12">
            ...
            <div class="tab-pane" id="paso6">
             ...
             <div class="tab-pane" id="paso7">
                <form class="form-horizontal">
                    <?=
                    $this->render('_formTab7Admin', [
                        'tipo_validacion' => $resp_validacion,
                        'per_id' => $per_id,
                        'estado' => $estado,
