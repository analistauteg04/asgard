...
<div class="col-md-12">    
    <h3><span id="lbl_titulo"><?= Yii::t("academico", "Create Period") ?></span><br/>    
</div>
...
<form class="form-horizontal" enctype="multipart/form-data" >
    ...
    <div class='col-md-12 col-sm-12 col-xs-12 col-lg-12'>
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                <label for="txt_nivel_interes" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" id="lbl_periodo"><?= Yii::t("formulario", "Academic unit") ?></label>
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    <?= Html::dropDownList("cmb_nivel_interes", 1, $arr_ninteres, ["class" => "form-control", "id" => "cmb_nivel_interes"]) ?>
                </div>
            </div>
        </div>  
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
