...
<div class="col-md-12">    
    <h3><span id="lbl_titulo"><?= Yii::t("formulario", "Executive Reassignment") ?></span>
</div>
...
<form class="form-horizontal" enctype="multipart/form-data" >
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label for="txt_agente" class="col-sm-4 control-label" id="lbl_interesado"><?= Yii::t("formulario", "Current Executive") ?></label>
            <div class="col-sm-8">
                <input type="text" value="<?= $agente ?>" class="form-control" id="txt_interesado" disabled="true" placeholder="<?= Yii::t("formulario", "Current Executive") ?>">                
            </div>
        </div>
    </div>      
    <div class="col-md-12">
    ...
    <div class="col-md-12"> 
        <div class="form-group">
            ...
            <div class="col-sm-4">                                  
                <a id="btn_ReasignarEjecutivo" class="btn btn-primary btn-block"> <?= Yii::t("formulario", "Send") ?></a>                                   
            </div> 
            <div class="col-sm-4">                                                  
            </div>  
        </div>    
