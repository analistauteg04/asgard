...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
        <div class="form-group">            
            <label for="lbl_inicio" class="col-sm-2 col-lg-2 col-md-2 col-xs-2 control-label"><?= Yii::t("formulario", "Start date") ?></label>
            ...
            <label for="lbl_fin" class="col-sm-2 col-sm-2 col-lg-2 col-md-2 col-xs-2 control-label"><?= Yii::t("formulario", "End date") ?></label>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
        <div class="form-group">
            <label for="cmb_estado" class="col-sm-2 col-sm-2 col-lg-2 col-md-2 col-xs-2 control-label"><?= Yii::t("formulario", "Process State") ?></label>
            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
