...
class PerfilController extends \app\components\CController {
    ...
    public function actionUpdate() {     
        ...
        {           
           ...
           $respContGeneral = $modContGeneral->consultarContactoGeneral($respPersona['per_id']);           
        ...
        $area = $mod_pais->consultarCodigoArea($respPersona['pai_id_domicilio']);
        ...
        return $this->render('update', [
                    ...
                    "respPersona" => $respPersona,  //revisar   "respPerinteresado" => $respPerinteresado,
                    "area" => $area,       
        ...
        if (Yii::$app->request->isAjax) {           
            ...
            try {               
                ...
                if ($respPersona) {
                    ...
                    if ($sincontacto != 1) { 
                        $verificarRegistroContactoGeneral = $modcontactogeneral->consultarContactoGeneral($per_id);                        
                       // $db_base = "db_asgard.persona";
                        if($verificarRegistroContactoGeneral){                             
                            $resp_contacto = $modcontactogeneral->modificarContactoGeneral($verificarRegistroContactoGeneral['contacto_id'],$per_id,$cgen_nombre,$cgen_apellido,$tpar_id,$cgen_direccion,$cgen_telefono,$cgen_celular);
                            if ($resp_contacto) {
                                $exito=1;
                            }
                        } else {                            
                            $resp_contacto= $modcontactogeneral->insertarContactoGeneral($per_id,$cgen_nombre,$cgen_apellido,$tpar_id,$cgen_direccion,$cgen_telefono,$cgen_celular);
                            if ($resp_contacto) {
                                $exito=1;
                            }
                        }                                              
